                        ...
                        <div className="d-flex gap-4 content p-3 px-md-4 py-md-5 px-lg-5 child-w-100 flex-wrap position-relative h-100 align-items-center">                              
                             <div className="back-arrow position-relative">
                                ...
                                <div className="text-content position-relative">
                                    ...
                                    <h2 className="text-white">SageMetrcis - Tech Support System.</h2>
                                    <p className="text-secondary2 mt-4">
                                       Log in with your Vitel Wireless iPartner account to access your dashboard and tools.
                                    </p>
                                </div>
                                <div className="content-icon position-relative">
                                    <img src="https://cdn.pixabay.com/photo/2016/06/15/16/16/man-1459246_1280.png" alt="" className="w-100"/>
                                </div>
                        </div>
                    </div>
                            ...
                            <div className="form-wrapper py-4">
                                ...
                                <form action="">
                                    ...
                                    <div className="form-input con-input-div mb-3 p-0">
                                        <label for="youremail" className="text-secondary label-margin" >Email Address</label>
                                        <div className="input-relative position-relative mt-1 mt-lg-2">
                                            <Input type="text" className="default-input  py-1 ps-3 py-lg-2 input-required" name="yourEmail" id="yourEmail" maxlength="40"></Input>
                                    ...
                                    <div className="form-input con-input-div mb-3 p-0">
                                        <label for="yourpassword" className="text-secondary label-margin">Password</label>
                                        <div className="input-relative position-relative mt-1 mt-lg-2">
                                            <Input type="password" className="default-input  py-1 ps-3 py-lg-2 input-required" name="yourPassword" id="yourPassword" maxlength="40"></Input>
                                            <div className="nameinput-icon-feedback icon-feedback">
                                                <i className="fa-solid fa-circle-exclamation text-danger icon"></i>
                                                <i className="fa-solid fa-circle-check text-success icon"></i>
                                            </div>
                                        ...
                                        <small><a href="javascript:void(0)" className="show-password"></a></small>
                                    ...
                                    <div className="form-submit">
                                        <button onClick={handleLogin} id="btnCreateAccount" type="button" className="btn  w-100  py-lg-2 mt-1 mt-lg-2 " >
                                            Login   
                                        </button>
                                    </div>
                                </form>
